...
def process_txt_file(update, context):
    ...
    # Filter out lines containing 'cpvod.testbook' or 'drive.google.com'
    filtered_lines = [line for line in lines if 'cpvod.testbook' not in line and 'drive.google.com' not in line]
